...
<div class="row show-grid">
        ...
        <div class="col-md-12 mb-3">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            <div class="text-xs fw-bold text-success text-uppercase mb-1">No. of Owners</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM user WHERE user_type_id = '2' AND active = '1'";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE property_status = 1";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE property_status = 0";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE status = 0";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE status = 2";
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Properties', 'Owners', 'Available Properties', 'Sold Properties', 'Pending Properties', 'Rejected Properties'],
                datasets: [{
                    label: 'Dashboard',
                    data: [<?php echo $propertyy; ?>, <?php echo $owners; ?>, <?php echo $av_property; ?>, <?php echo $sold_properties; ?>, <?php echo $pending_properties; ?>, <?php echo $rejected_properties; ?>],
                    borderWidth: 1
                }]
            },
            options: {
