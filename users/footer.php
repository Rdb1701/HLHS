      ...
      <footer class="page-footer">
      	<p class="mb-0">ICT Maintenance Information System &copy; 2023</p>
      </footer>
      </div>
      				...
      				<div class="modal-body mx-4">
      					...
      					<div class="md-form">
      						...
      						<input type="text" class="form-control"
      							value="<?php echo $_SESSION['admin']['username']; ?>" readonly>
      					</div>

      					<div class="md-form">
      						<label data-error="wrong" data-success="right">Enter New Password <span
      								class="text-danger">*</span></label>
      						<input type="password" class="form-control" id="new_password" autocomplete="off">
      					</div>

      					<div class="md-form">
      						<label data-error="wrong" data-success="right">Re-enter New Password <span
      								class="text-danger">*</span></label>
