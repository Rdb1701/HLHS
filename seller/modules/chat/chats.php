...
WHERE to_user_id = '" . $_SESSION['seller']['seller_id'] . "'
AND prop.user_id = '" . $_SESSION['seller']['owner_id'] . "'
";
...
";
  ...
  $button = "
    ...
    ";
  $data['data'][] = array($value['u_name'] .count_unseen_message($value['user_id'], $_SESSION['seller']['seller_id'],$value['property_id'], $db), $type_name, $location, $button);
}
