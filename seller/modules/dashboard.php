...
<div class="row show-grid">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE user_id = '" . $_SESSION['seller']['owner_id'] . "'";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE user_id = '" . $_SESSION['seller']['owner_id'] . "' AND property_status = 1";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE user_id = '" . $_SESSION['seller']['owner_id'] . "' AND property_status = 0";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE user_id = '" . $_SESSION['seller']['owner_id']. "' AND status = 0";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 fw-bold">
                                <?php
                                $query = "SELECT COUNT(*) FROM property WHERE user_id = '" . $_SESSION['seller']['owner_id'] . "' AND status = 2";
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Properties', 'Available Properties', 'Sold Properties', 'Pending Properties', 'Rejected Properties'],
                datasets: [{
                    label: 'Dashboard',
                    data: [<?php echo $propertyy; ?>, <?php echo $av_property; ?>, <?php echo $sold_properties; ?>, <?php echo $pending_properties; ?>, <?php echo $rejected_properties; ?>],
                    borderWidth: 1
                }]
            },
            options: {
