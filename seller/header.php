...
include "appointments/function.php";
...
<head>
	...
	<link href="../../admin/assets/datatable/datatables.min.css" rel="stylesheet">
	<!-- additionals -->
			...
			<ul class="metismenu" id="menu">
				...
				<li class="" style="padding: 10px;">
					<a href="../modules/chats">
						...
						<div class="menu-title">Chats <?php echo count_all_unseen_message($_SESSION['seller']['seller_id'], $db); ?></div>
					</a>
				</li>
				<li class="" style="padding: 10px;">
					<a href="appointment">
						...
						<div class="menu-title">Appointments <?php echo count_all_appointments($_SESSION['seller']['owner_id'], $db); ?></div>
					</a>
				</li>

				<li class="" style="padding: 10px;">
					<a href="shares">
						<div class="parent-icon"><i class="fa fa-money-bill"></i>
							<!-- <i class='bx bx-home'></i> -->
						</div>
						<div class="menu-title">Shares</div>
					</a>
				</li>
			</ul>
			<!--end navigation-->
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info ps-3">
								<p class="user-name mb-0">
									...
									<?php echo $_SESSION['seller']['u_name']; ?>
								</p>
								<p class="designattion mb-0">
									<?php echo $_SESSION['seller']['username']; ?>
								</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li>
								<a class="dropdown-item" href="../../includes/logout_seller"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
